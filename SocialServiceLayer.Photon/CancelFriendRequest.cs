...
{
	internal class CancelFriendRequest : SocialRequest<IList<Friend>>, ICancelFriendRequest, IServiceRequest<string>, IAnswerOnComplete<IList<Friend>>, IServiceRequest
	{
		...
		public CancelFriendRequest()
			: base("strRobocloudError", "strCancelInviteError", 0)
		{
		}
