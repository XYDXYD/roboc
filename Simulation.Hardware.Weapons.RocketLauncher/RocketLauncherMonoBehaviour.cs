...
{
	internal sealed class RocketLauncherMonoBehaviour : MonoBehaviour, IFireTimingComponent, IProjectileRangeComponent, IProjectileSpeedStatsComponent, ISplashDamageComponent, IHomingProjectileStatsComponent, IProjectileEffectImpactSuccessfulComponent, IProjectileEffectImpactSelfComponent, IProjectileEffectImpactEnvironmentComponent, IProjectileEffectImpactProtoniumComponent, IProjectileEffectImpactFusionShieldComponent, IShootingComponent, IRecoilForceComponent, IHitSomethingComponent, IWeaponFiringAudioComponent, IWeaponNoFireAudioComponent, ILockOnTargetingParametersComponent, IProjectileEffectImpactEqualizerComponent
	{
		public float recoilForce = 10f;

		public float lockConeDotLowerLimit = 0.996f;

		public bool looseLock;

		public bool notifyTargetAboutLock;
		...
		float ILockOnTargetingParametersComponent.lockTime
		{
			get;
			set;
		}

		float ILockOnTargetingParametersComponent.fullLockReleaseTime
		{
			get;
			set;
		}

		float ILockOnTargetingParametersComponent.changeLockTime
		{
			get;
			set;
		}

		float ILockOnTargetingParametersComponent.lockOnConeDot
		{
			get
			{
				return lockConeDotLowerLimit;
			}
		}

		bool ILockOnTargetingParametersComponent.isLooseLock
		{
			get
			{
				return looseLock;
		...
		bool ILockOnTargetingParametersComponent.notifyTargetOfLock
		{
			get
			{
				return notifyTargetAboutLock;
			}
		}
		...
		public RocketLauncherMonoBehaviour()
			: this()
		{
		}
