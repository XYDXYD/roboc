...
namespace Login
{
	public class WidgetUserValidationResendEmailController : ISplashLoginDialogController
	{
		private WidgetUserValidationResendEmailView _view;
		...
		{
			_view = (splashLoginDialogView as WidgetUserValidationResendEmailView);
