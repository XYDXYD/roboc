...
namespace Login
{
	public class WidgetNewsletterController : ISplashLoginDialogController
	{
		private WidgetNewsletterView _view;
		...
		{
			_view = (splashLoginDialogView as WidgetNewsletterView);
