...
namespace Login
{
	internal class EnterUsernameAndPasswordDialogView : MonoBehaviour, ISplashLoginDialogView
	{
		[SerializeField]
		...
		private EnterUsernameAndPasswordDialogController _controller;
		...
		public EnterUsernameAndPasswordDialogView()
			: this()
		{
		}
		...
		{
			_controller = (controller as EnterUsernameAndPasswordDialogController);
		}
