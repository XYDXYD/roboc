...
internal class GameModeChoiceFilterView : MonoBehaviour, IChainListener, IInitialize
{
	...
	[Inject]
	internal GameModeChoiceFilterPresenter gameModeChoicePresenter
	{
		private get;
		set;
	}
	...
	public GameModeChoiceFilterView()
		: this()
	{
	}
	...
	unsafe void IInitialize.OnDependenciesInjected()
	{
		...
		gameModeChoicePresenter.SetView(this);
	}
	...
	public void Listen(object message)
	{
		...
		{
			gameModeChoicePresenter.OnGUIEvent((CustomGameGUIEvent)message);
		}
	}
	...
	{
		gameModeChoicePresenter.OnItemSelected();
	}
}
