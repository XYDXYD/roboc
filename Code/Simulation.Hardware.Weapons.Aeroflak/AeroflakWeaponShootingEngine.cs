...
{
	internal sealed class AeroflakWeaponShootingEngine : SingleEntityViewEngine<AeroflakWeaponShootingNode>
	{
		private WeaponFiredObservable _weaponFiredObservable;

		private Dictionary<int, AeroflakWeaponShootingNode> _weapons = new Dictionary<int, AeroflakWeaponShootingNode>();
		...
		public AeroflakWeaponShootingEngine(WeaponFiredObservable weaponFiredObservable)
		{
			_weaponFiredObservable = weaponFiredObservable;
		}

		protected override void Add(AeroflakWeaponShootingNode obj)
		{
			obj.projectileCreationComponent.createProjectile.subscribers += CreateProjectile;
			_weapons.Add(obj.get_ID(), obj);
		}

		protected override void Remove(AeroflakWeaponShootingNode obj)
		{
			obj.projectileCreationComponent.createProjectile.subscribers -= CreateProjectile;
		...
		private void CreateProjectile(IProjectileCreationComponent sender, ProjectileCreationParams projectileCreationParams)
		{
			...
			if (_weapons.TryGetValue(value, out AeroflakWeaponShootingNode value2))
			{
