...
{
	internal sealed class MachineInvisibilityImplementor : IMachineVisibilityComponent, IManaDrainComponent, ICloakStatsComponent
	{
		...
		public MachineInvisibilityImplementor()
		{
