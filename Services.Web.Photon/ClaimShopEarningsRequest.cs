...
{
	internal sealed class ClaimShopEarningsRequest : WebServicesRequest<LoadShopEarningsResponse>, IClaimShopEarningsRequest, IServiceRequest, IAnswerOnComplete<LoadShopEarningsResponse>
	{
		protected override byte OperationCode => 89;

		public ClaimShopEarningsRequest()
			: base("strRobotShopError", "strErrorClaimCommunityShopEarnings", 0)
		{
		}
