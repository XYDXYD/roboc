...
{
	internal sealed class LaserWeaponMonoBehaviour : MonoBehaviour, IFireTimingComponent, IProjectileRangeComponent, IProjectileSpeedStatsComponent, IShootingComponent, IRecoilForceComponent, IHitSomethingComponent, IWeaponFiringAudioComponent, IWeaponNoFireAudioComponent, IProjectileEffectImpactSuccessfulComponent, IProjectileEffectImpactSelfComponent, IProjectileEffectImpactEnvironmentComponent, IProjectileEffectImpactProtoniumComponent, IProjectileEffectImpactFusionShieldComponent, IProjectileEffectImpactEqualizerComponent
	{
		...
		public LaserWeaponMonoBehaviour()
			: this()
		{
		}
